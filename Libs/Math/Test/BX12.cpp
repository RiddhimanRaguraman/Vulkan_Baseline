...
TEST(BX12_Hint_R_T, TestConfig::ALL)
{
#if BX12_Hint_R_T
	Mat4 M;
	Rot A(Rot1::Z, 0.12f);
	...
	CHECK(eq_float(B[m12], 3.000f));
	CHECK(eq_float(B[m13], 4.000f));
	CHECK(eq_float(B[m14], 5.000f));
	CHECK(eq_float(B[m15], 1.000f));

	CHECK(eq_float(M[m0], 0.993f));
	CHECK(eq_float(M[m1], 0.120f));
	CHECK(eq_float(M[m2], 0.000f));
	CHECK(eq_float(M[m3], 0.000f));
	CHECK(eq_float(M[m4], -0.120f));
	CHECK(eq_float(M[m5], 0.993f));
	...
	CHECK(eq_float(M[m12], 3.000f));
	CHECK(eq_float(M[m13], 4.000f));
	CHECK(eq_float(M[m14], 5.000f));
