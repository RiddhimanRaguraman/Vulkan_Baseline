...
TEST(BX3_Hint_M_R, TestConfig::ALL)
{
#if BX3_Hint_M_R
	Mat4 M;
	...
	CHECK(eq_float(B[m5], 0.974f));
	CHECK(eq_float(B[m6], 0.228f));
	CHECK(eq_float(B[m7], 0.000f));
	CHECK(eq_float(B[m8], 0.000f));
	CHECK(eq_float(B[m9], -0.228f));
	CHECK(eq_float(B[m10], 0.974f));
	...
	CHECK(eq_float(M[m1], 1.263f));
	CHECK(eq_float(M[m2], 3.377f));
	CHECK(eq_float(M[m3], 4.000f));
	CHECK(eq_float(M[m4], 5.000f));
	CHECK(eq_float(M[m5], 4.246f));
	CHECK(eq_float(M[m6], 8.184f));
	CHECK(eq_float(M[m7], 8.000f));
	CHECK(eq_float(M[m8], 9.000f));
	CHECK(eq_float(M[m9], 7.229f));
	CHECK(eq_float(M[m10], 12.990f));
	CHECK(eq_float(M[m11], 12.000f));
	CHECK(eq_float(M[m12], 13.000f));
	CHECK(eq_float(M[m13], 10.212f));
	CHECK(eq_float(M[m14], 17.797f));
