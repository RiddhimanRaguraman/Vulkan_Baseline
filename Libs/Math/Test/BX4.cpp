...
TEST(BX4_Hint_M_T, TestConfig::ALL)
{
#if BX4_Hint_M_T
	Mat4 M;
	...
	CHECK(eq_float(B[m12], 1.000f));
	CHECK(eq_float(B[m13], 2.000f));
	CHECK(eq_float(B[m14], 3.000f));
	CHECK(eq_float(B[m15], 1.000f));

	CHECK(eq_float(M[m0], 5.000f));
	CHECK(eq_float(M[m1], 10.000f));
	CHECK(eq_float(M[m2], 15.000f));
	CHECK(eq_float(M[m3], 4.000f));
	CHECK(eq_float(M[m4], 13.000f));
	CHECK(eq_float(M[m5], 22.000f));
	CHECK(eq_float(M[m6], 31.000f));
	CHECK(eq_float(M[m7], 8.000f));
	CHECK(eq_float(M[m8], 21.000f));
	CHECK(eq_float(M[m9], 34.000f));
	CHECK(eq_float(M[m10], 47.000f));
	CHECK(eq_float(M[m11], 12.000f));
	CHECK(eq_float(M[m12], 29.000f));
	CHECK(eq_float(M[m13], 46.000f));
	CHECK(eq_float(M[m14], 63.000f));
