...
namespace Azul
{
	...
	Mat4Test::Mat4Test(const Vec4 &tV0, const Vec4 &tV1, const Vec4 &tV2, const Vec4 &tV3)
	...
	Mat4Test::Mat4Test(const Quat &q)
	{
	...
	Mat4Test Mat4Test::getInv2(void) const
	{
		Mat4Test tmp;
	...
	Mat4Test Mat4Test::privGetAdj(void) const
	{
	...
	Mat4Test Mat4Test::operator * (const Mat4Test &A) const
	{
		Mat4Test m(
			   Vec4((_m0 * A._m0) + (_m1 * A._m4) + (_m2 * A._m8) + (_m3 * A._m12),
	...
	Mat4Test &Mat4Test::operator *= (const Mat4Test &A)
	{
		_v0.set((_m0 * A._m0) + (_m1 * A._m4) + (_m2 * A._m8) + (_m3 * A._m12),
				(_m0 * A._m1) + (_m1 * A._m5) + (_m2 * A._m9) + (_m3 * A._m13),
				(_m0 * A._m2) + (_m1 * A._m6) + (_m2 * A._m10) + (_m3 * A._m14),
				(_m0 * A._m3) + (_m1 * A._m7) + (_m2 * A._m11) + (_m3 * A._m15));

		_v1.set((_m4 * A._m0) + (_m5 * A._m4) + (_m6 * A._m8) + (_m7 * A._m12),
				(_m4 * A._m1) + (_m5 * A._m5) + (_m6 * A._m9) + (_m7 * A._m13),
				(_m4 * A._m2) + (_m5 * A._m6) + (_m6 * A._m10) + (_m7 * A._m14),
				(_m4 * A._m3) + (_m5 * A._m7) + (_m6 * A._m11) + (_m7 * A._m15));

		_v2.set((_m8 * A._m0) + (_m9 * A._m4) + (_m10 * A._m8) + (_m11 * A._m12),
				(_m8 * A._m1) + (_m9 * A._m5) + (_m10 * A._m9) + (_m11 * A._m13),
				(_m8 * A._m2) + (_m9 * A._m6) + (_m10 * A._m10) + (_m11 * A._m14),
				(_m8 * A._m3) + (_m9 * A._m7) + (_m10 * A._m11) + (_m11 * A._m15));

		_v3.set((_m12 * A._m0) + (_m13 * A._m4) + (_m14 * A._m8) + (_m15 * A._m12),
				(_m12 * A._m1) + (_m13 * A._m5) + (_m14 * A._m9) + (_m15 * A._m13),
				(_m12 * A._m2) + (_m13 * A._m6) + (_m14 * A._m10) + (_m15 * A._m14),
				(_m12 * A._m3) + (_m13 * A._m7) + (_m14 * A._m11) + (_m15 * A._m15));
