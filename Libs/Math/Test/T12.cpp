...
TEST(Trans_Times_Mat4, TestConfig::ALL)
{
#if Trans_Times_Mat4
	...
	CHECK(eq_float(C[m0], 1.0f));
	CHECK(eq_float(C[m1], 2.0f));
	CHECK(eq_float(C[m2], 3.0f));
	CHECK(eq_float(C[m3], 4.0f));
	CHECK(eq_float(C[m4], 5.0f));
	CHECK(eq_float(C[m5], 6.0f));
	CHECK(eq_float(C[m6], 7.0f));
	CHECK(eq_float(C[m7], 8.0f));
	CHECK(eq_float(C[m8], 9.0f));
	CHECK(eq_float(C[m9], 10.0f));
	CHECK(eq_float(C[m10], 11.0f));
	CHECK(eq_float(C[m11], 12.0f));
	CHECK(eq_float(C[m12], 81.0f));
	CHECK(eq_float(C[m13], 94.0f));
	CHECK(eq_float(C[m14], 107.0f));
	CHECK(eq_float(C[m15], 120.0f));
