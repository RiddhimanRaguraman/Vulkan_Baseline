...
TEST(Mat4_Times_Quat, TestConfig::ALL)
{
#if Mat4_Times_Quat
	...
	Mat4Hint::Hint h = ((Mat4Hint &)C).GetHint();
	...
	CHECK(eq_float(C[m0],   -2.5569f));
	CHECK(eq_float(C[m1],   -2.6650f));
	CHECK(eq_float(C[m2],   -0.5996f));
	CHECK(eq_float(C[m3],    4.0000f));
	CHECK(eq_float(C[m4],   -8.7314f));
	CHECK(eq_float(C[m5],   -5.3971f));
	CHECK(eq_float(C[m6],   -2.1525f));
	CHECK(eq_float(C[m7],    8.0000f));
	CHECK(eq_float(C[m8],  -14.9058f));
	CHECK(eq_float(C[m9],   -8.1291f));
	CHECK(eq_float(C[m10],  -3.7055f));
	CHECK(eq_float(C[m11],  12.0000f));
	CHECK(eq_float(C[m12], -21.0803f));
	CHECK(eq_float(C[m13], -10.8612f));
	CHECK(eq_float(C[m14],  -5.2584f));
